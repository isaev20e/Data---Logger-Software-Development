...
int main(){
  ...
  x5 = wiringPiI2CReadReg8(fd,0x19);   //SMPLRT_DIV
  x6 = wiringPiI2CReadReg8(fd,0x1A);   //CONFIG
  x7 = wiringPiI2CReadReg8(fd,0x1B);   //GYRO_CONFIG
  x8 = wiringPiI2CReadReg8(fd,0x1C);   //ACCEL_CONFIG
